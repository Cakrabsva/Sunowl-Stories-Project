...
const { OpenTrips, TripItineraries, TripDates, TripCategories, TripImages } = require('../models');
...
class OpenTripController {
    static async getOneOpenTrip (req, res, next) {
        try {
            ...
            const openTrips = await OpenTrips.findByPk(tripId, {include: [{model: TripItineraries}, {model: TripDates}, {model: TripCategories}, {model: TripImages},]})
